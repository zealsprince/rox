...
grid-always = Immer
    .description = Die Cover auch dann zurücknehmen, wenn nichts läuft; nur ein überfahrenes Cover zeigt sich ganz
...
settings-appearance-font-size = Schriftgröße
    .description = Die Basisgröße, von der der Text jedes Panels skaliert; Steuerelemente und Symbole behalten ihre Größe
...
history-view-recent = Zuletzt gespielt
history-view-recent-short = Zuletzt
