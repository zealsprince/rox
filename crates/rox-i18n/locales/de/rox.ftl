...
library-empty-note = Er wird in die Bibliothek eingelesen (flac, mp3, ogg, opus, m4a, aac, wav, aiff)
...
settings-appearance-chrome-side = Seite der Fensterknöpfe
    .description = An welchem Ende der eigenen Titelleiste von rox die Knöpfe sitzen; wird gezeichnet, wo der Compositor das Fenster nicht dekoriert, und auf rahmenlosen Unterfenstern
settings-appearance-chrome-side-left = Links
settings-appearance-chrome-side-right = Rechts
settings-appearance-chrome-style = Stil der Fensterknöpfe
    .description = Wie die Knöpfe auf der eigenen Titelleiste von rox gezeichnet werden; wird gezeichnet, wo der Compositor das Fenster nicht dekoriert, und auf rahmenlosen Unterfenstern
settings-appearance-cjk-fonts-note = Für japanischen, chinesischen und koreanischen Text in deiner Bibliothek wird jede installierte Schrift der Reihe nach durchprobiert. Das bremst das Scrollen, und der Text erscheint in einer Ersatzschrift. Installiere die statischen Noto-Sans-CJK-Schriften: noto-fonts-cjk-sans-static unter NixOS, google-noto-sans-cjk-fonts unter Fedora, noto-fonts-cjk unter Arch, fonts-noto-cjk unter Debian.
settings-appearance-cjk-fonts-title = Keine CJK-Schrift in normaler Stärke gefunden
...
settings-appearance-bare-child-windows = Rahmenlose Unterfenster
    .description = Bei ausgeschalteten Systemdekorationen verlieren auch Einstellungen, Editoren und herausgelöste Panels den Systemrahmen und zeichnen die eigene Titelleiste von rox; der Größenänderungsrand gilt dann auch für sie
settings-appearance-child-titlebar = Titelleiste der Unterfenster
    .description = Die eigene Titelleiste von rox auf rahmenlosen Unterfenstern; ausgeschaltet bleiben sie ganz ohne Rahmen, und das Kürzel „Fenster schließen“ schließt sie
...
settings-integrations-discord-first-line = Erste Zeile
    .description = Die erste Zeile der Karte, unter rox, und was die Mitgliederliste standardmäßig wiederholt
settings-integrations-discord-hover-line = Cover-Tooltip
    .description = Der Text hinter dem Cover, beim Darüberfahren. Leer heißt kein Tooltip
settings-integrations-discord-line-off = Leer, die Karte lässt diese Zeile weg
settings-integrations-discord-line-preview = Vorschau: { $line }
settings-integrations-discord-second-line = Zweite Zeile
    .description = Die zweite Zeile der Karte. Leer lassen, dann fällt sie von der Karte weg
...
settings-integrations-discord-status-line = Statuszeile
    .description = Was Discord neben deinem Namen in der Mitgliederliste zeigt
settings-integrations-discord-status-line-app = App-Name
settings-integrations-discord-status-line-first = Erste Zeile
settings-integrations-discord-status-line-second = Zweite Zeile
...
settings-integrations-subsonic-name = Name
    .description = Wie rox diesen Server nennt; solange das leer ist, steht die Adresse dafür
settings-integrations-subsonic-name-placeholder = Zuhause
settings-integrations-subsonic-new = Neuer Server
settings-integrations-subsonic-password-placeholder = Passwort
settings-integrations-subsonic-remove = Server entfernen
    .description = Die Anmeldung für diesen Server vergessen und seine Titel aus der Bibliothek löschen; ausgeschaltet bleiben sie, nur versteckt
...
settings-integrations-subsonic-use = Diesen Server nutzen
    .description = Seine Bibliothek lesen und daraus abspielen; ausgeschaltet bleiben seine Titel in der Bibliothek, nur versteckt
...
settings-library-add-folder = Ordner...
settings-library-add-subsonic = Subsonic-Server...
settings-library-col-source = Quelle
settings-library-duplicates = Duplikate...
settings-library-embed-button = Gespeicherte Metadaten einbetten...
settings-library-exclude-col = Ausgeschlossen
settings-library-exclude-intro = Dateien und Ordner, die die Bibliothek in allen Quellen oben auslässt. Ein Name wie *.tmp passt überall, ein Pfad wie Live/** beginnt ganz oben in jedem Ordner. Groß- und Kleinschreibung spielt keine Rolle, und ein passender Ordner wird ganz übersprungen. Die Dateien selbst bleiben in Ruhe
settings-library-exclude-invalid = Dieses Muster lässt sich nicht lesen: { $reason }
settings-library-exclude-none = Nichts ausgeschlossen
settings-library-exclude-nudge = Muster geändert: die Überwachung folgt sofort. Titel, die schon in der Bibliothek sind, bleiben, bis du oben in der Kopfzeile Quellen auf Neu einlesen drückst
settings-library-exclude-placeholder = *.tmp oder Live/**
settings-library-folder-col-albums = Alben
settings-library-folder-col-size = Größe
settings-library-folder-col-tracks = Titel
settings-library-folders-intro = Ordner und Server, aus denen die Bibliothek liest; eine Quelle zu entfernen wirft ihre Titel aus dem Katalog, die Dateien eines Ordners bleiben in Ruhe
settings-library-genre-separator-nudge = Trennzeichen geändert: das Stöbern folgt sofort. Genrelisten aus früheren Scans behalten ihre alte Form, bis du oben in der Kopfzeile Quellen auf Neu einlesen drückst
...
settings-library-no-sources = Noch keine Quellen
...
settings-library-section-sources = Quellen
...
settings-playback-live-buffer-cap = Der Puffer endet bei { $cap }, egal wie lang er eingestellt ist: ein Zehntel des Arbeitsspeichers dieses Rechners.
...
settings-playback-capture-buffer-title = Der Live-Puffer ist kürzer als die meisten Songs
settings-playback-capture-buffer-note = Er steht auf { $buffer }, und ein Song wird nur gespeichert, wenn er am Ende noch ganz im Puffer liegt. { $default } deckt fast alles ab, was ein Sender spielt.
...
settings-common-add = Hinzufügen
...
settings-confirm-remove-subsonic-body = Die Anmeldung wird vergessen und seine Titel verlassen die Bibliothek. Sie wiederzuhaben heißt, neu zu verbinden und abzugleichen; ausschalten behält sie stattdessen.
settings-confirm-remove-subsonic-title = "{ $name }" entfernen?
...
tags-editor-guess-help = / passt auf den Ordner darüber, %skip% verwirft
...
tags-guess-placeholders = Platzhalter
...
tags-rename-pattern-help = / macht einen Ordner ab dem Bibliotheksordner, ohne / wird an Ort und Stelle umbenannt, die Endung folgt der Datei
...
convert-dialog-pattern-help = / macht einen Ordner, das Format setzt die Endung
...
lyrics-bold = Fett
lyrics-build-word-by-word = Den Wörtern beim Singen folgen
    .description = Einen Lesekopf durch die aktive Zeile laufen lassen, nach den Wortzeiten des Blatts, wenn es welche hat
...
lyrics-head-build = Aufbau
lyrics-head-fill = Füllung
lyrics-hide-upcoming = Kommende Zeilen verbergen
    .description = Jede Zeile, die der Abspielkopf noch nicht erreicht hat, verborgen halten, damit sich das Blatt beim Abspielen aufdeckt
...
lyrics-read-head-style = Lesekopf
    .description = Wie die aktive Zeile den Kopf zeigt: als Karaoke-Füllung, die darüberzieht, oder Wort für Wort aufgebaut
...
lyrics-unsung-dim = Ungesungenes abdunkeln
    .description = Wie stark die Füllung den noch nicht gesungenen Teil der aktiven Zeile abdunkelt
lyrics-wipe-lyrics = Songtext löschen
lyrics-wrap-lines = Lange Zeilen umbrechen
    .description = Eine für das Panel zu breite Zeile in die nächste Reihe laufen lassen, statt sie abzuschneiden
