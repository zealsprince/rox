...
settings-appearance-chrome-side = Seite der Fensterknöpfe
    .description = An welchem Ende der eigenen Titelleiste von rox die Knöpfe sitzen; wird nur gezeichnet, wo der Compositor das Fenster nicht dekoriert
...
settings-appearance-chrome-style = Stil der Fensterknöpfe
    .description = Wie die Knöpfe auf der eigenen Titelleiste von rox gezeichnet werden; wird nur gezeichnet, wo der Compositor das Fenster nicht dekoriert
