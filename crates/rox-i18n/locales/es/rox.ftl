...
settings-appearance-chrome-side = Lado de los botones de ventana
    .description = En qué extremo de la barra de título propia de rox van los botones; solo se dibuja donde el compositor no decora la ventana
...
settings-appearance-chrome-style = Estilo de los botones de ventana
    .description = Cómo se dibujan los botones de la barra de título propia de rox; solo se dibuja donde el compositor no decora la ventana
