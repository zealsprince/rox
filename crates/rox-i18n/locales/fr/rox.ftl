...
library-empty-note = Il sera analysé dans la bibliothèque (flac, mp3, ogg, opus, m4a, aac, wav, aiff)
...
stations-play = Lire
stations-play-count = Lire { $count } stations
stations-remove = Supprimer
stations-remove-count = Supprimer { $count } stations
...
stations-checking = Vérification du flux...
stations-is-hls = C'est une liste de segments HLS ; rox lit un flux continu
stations-is-a-playlist = C'est une liste de stations ; ouvrez-la avec Importer des stations
stations-not-audio = Cette URL répond en { $kind }, pas en audio
stations-added-unchecked = Ajoutée sans vérification : le flux n'a pas répondu ({ $reason })
...
settings-appearance-chrome-side = Côté des boutons de fenêtre
    .description = À quel bout de la barre de titre propre à rox les boutons se placent ; dessinée là où le compositeur ne décore pas la fenêtre, et sur les fenêtres secondaires sans cadre
settings-appearance-chrome-side-left = Gauche
settings-appearance-chrome-side-right = Droite
settings-appearance-chrome-style = Style des boutons de fenêtre
    .description = Comment les boutons de la barre de titre propre à rox sont dessinés ; dessinée là où le compositeur ne décore pas la fenêtre, et sur les fenêtres secondaires sans cadre
settings-appearance-cjk-fonts-note = Le texte japonais, chinois ou coréen de ta bibliothèque essaie toutes les polices installées une par une. Le défilement ralentit et le texte s'affiche dans une police de remplacement. Installe les polices Noto Sans CJK statiques : noto-fonts-cjk-sans-static sous NixOS, google-noto-sans-cjk-fonts sous Fedora, noto-fonts-cjk sous Arch, fonts-noto-cjk sous Debian.
settings-appearance-cjk-fonts-title = Aucune police CJK de graisse normale
...
settings-appearance-bare-child-windows = Fenêtres secondaires sans cadre
    .description = Avec les décorations système désactivées, les réglages, les éditeurs et les panneaux détachés perdent aussi le cadre système et dessinent la barre de titre propre à rox ; la bordure de redimensionnement s'applique à elles aussi
settings-appearance-child-titlebar = Barre de titre des fenêtres secondaires
    .description = La barre de titre que rox dessine sur les fenêtres secondaires sans cadre ; désactivée, elles n'ont plus rien autour, et le raccourci Fermer la fenêtre les ferme
...
settings-integrations-discord-first-line = Première ligne
    .description = La première ligne de la carte, sous rox, et ce que la liste des membres répète par défaut
settings-integrations-discord-hover-line = Infobulle de la pochette
    .description = Le texte derrière la pochette, au survol. Vide laisse la pochette sans infobulle
settings-integrations-discord-line-off = Vide, la carte laisse cette ligne de côté
settings-integrations-discord-line-preview = Aperçu : { $line }
settings-integrations-discord-second-line = Deuxième ligne
    .description = La deuxième ligne de la carte. Laisse-la vide pour la retirer de la carte
...
settings-integrations-discord-status-line = Ligne de statut
    .description = Ce que Discord affiche à côté de ton nom dans la liste des membres
settings-integrations-discord-status-line-app = Nom de l'application
settings-integrations-discord-status-line-first = Première ligne
settings-integrations-discord-status-line-second = Deuxième ligne
...
settings-integrations-subsonic-name = Nom
    .description = Le nom que rox donne à ce serveur ; tant qu'il est vide, l'adresse le remplace
settings-integrations-subsonic-name-placeholder = Maison
settings-integrations-subsonic-new = Nouveau serveur
settings-integrations-subsonic-password-placeholder = Mot de passe
settings-integrations-subsonic-remove = Retirer le serveur
    .description = Oublier les identifiants de ce serveur et supprimer ses pistes de la bibliothèque ; le désactiver les garde, masquées
...
settings-integrations-subsonic-use = Utiliser ce serveur
    .description = Lire sa bibliothèque et jouer à partir de là ; désactivé, ses pistes restent dans la bibliothèque, masquées
...
settings-library-add-folder = Dossier...
settings-library-add-subsonic = Serveur Subsonic...
...
settings-library-exclude-col = Exclus
settings-library-exclude-intro = Fichiers et dossiers que la bibliothèque laisse de côté dans toutes les sources ci-dessus. Un nom comme *.tmp correspond partout, et un chemin comme Live/** part du haut de chaque dossier. La casse ne compte pas, et un dossier qui correspond est ignoré en entier. Les fichiers eux-mêmes restent tranquilles
settings-library-exclude-invalid = Impossible de lire ce motif : { $reason }
settings-library-exclude-none = Rien d'exclu
settings-library-exclude-nudge = Motifs modifiés : la surveillance suit tout de suite. Les pistes déjà dans la bibliothèque restent jusqu'à ce que tu lances Réanalyser dans l'en-tête Sources
settings-library-exclude-placeholder = *.tmp ou Live/**
...
settings-library-folders-intro = Dossiers et serveurs d'où la bibliothèque est lue ; en retirer un enlève ses pistes du catalogue et laisse tranquilles les fichiers d'un dossier
settings-library-genre-separator-nudge = Séparateurs modifiés : la navigation suit tout de suite. Les listes de genres stockées par les analyses précédentes gardent leur ancienne forme jusqu'à ce que tu lances Réanalyser dans l'en-tête Sources
...
settings-library-no-sources = Aucune source pour l'instant
...
settings-library-section-sources = Sources
...
settings-playback-live-buffer-cap = Le tampon s'arrête à { $cap } quelle que soit la durée réglée : un dixième de la mémoire de cette machine.
...
settings-playback-capture-buffer-title = Le tampon du direct est plus court que la plupart des morceaux
settings-playback-capture-buffer-note = Il est à { $buffer }, et un morceau n'est enregistré que s'il tient encore en entier dans le tampon à la fin. { $default } couvre presque tout ce que passe une station.
...
settings-playback-capture-pattern-source = %source% est le type de source d'où vient le flux, ainsi un nouveau type se range dans son propre dossier.
...
settings-common-done = Terminé
settings-common-download = Télécharger
settings-common-remove = Retirer
...
settings-confirm-remove-subsonic-body = Les identifiants sont oubliés et ses pistes quittent la bibliothèque. Les retrouver veut dire se reconnecter et resynchroniser ; le désactiver les garde plutôt.
settings-confirm-remove-subsonic-title = Retirer « { $name } » ?
...
autoeq-save = Enregistrer
autoeq-saved = Enregistré
autoeq-saved-info = Enregistré sous « { $name } »
autoeq-save-failed = Impossible d'écrire le fichier de préréglage
autoeq-applied-info = Appliqué : { $name } ({ $source })
autoeq-applied-info-preamp = Appliqué : { $name } ({ $source }), préampli { $db } dB
autoeq-imported-info = Importé : { $name }
autoeq-imported-info-preamp = Importé : { $name }, préampli { $db } dB
autoeq-read-failed = Impossible d'ouvrir le fichier : { $reason }
autoeq-parse-failed = Impossible de lire le profil : { $reason }
autoeq-import-untitled = Personnalisé
eq-flatten = Aplatir
eq-freq-label = Fréq
eq-gain-label = Gain
...
eq-preset-export = Exporter
eq-preset-export-default = Égaliseur
eq-preset-name = Nom du préréglage
eq-preset-save = Enregistrer le préréglage
eq-presets = Préréglages
...
keymap-cue-clear = Effacer les repères
    .description = Retirer tous les repères de session de la piste en lecture
...
lastfm-import-history = Lecture de l'historique des scrobbles
...
tags-editor-guess-help = / correspond au dossier au-dessus, %skip% écarte
...
tags-guess-placeholders = Variables
...
tags-rename-pattern-help = / crée un dossier depuis la racine de la bibliothèque, sans / le fichier est renommé sur place, l'extension suit le fichier
...
convert-dialog-pattern-help = / crée un dossier, le format fixe l'extension
...
lyrics-bold = Gras
lyrics-build-word-by-word = Suivre les mots chantés
    .description = Faire courir une tête de lecture dans la ligne active, sur les temps de mots de la feuille quand elle en a
...
lyrics-head-build = Construction
lyrics-head-fill = Remplissage
lyrics-hide-upcoming = Masquer les lignes à venir
    .description = Garder hors de vue chaque ligne que la tête de lecture n'a pas atteinte, pour que la feuille se découvre à mesure
...
lyrics-read-head-style = Tête de lecture
    .description = Comment la ligne active montre la tête : un remplissage karaoké qui la balaie, ou chaque mot qui se construit à son tour
...
lyrics-unsung-dim = Atténuation du non chanté
    .description = À quel point le remplissage assombrit la part de la ligne active qui n'est pas encore chantée
lyrics-wipe-lyrics = Effacer les paroles
lyrics-wrap-lines = Renvoyer les lignes longues
    .description = Laisser une ligne trop large pour le panneau passer sur une autre rangée au lieu d'être coupée
...
player-stream-refused = Piste ignorée : { $reason }
