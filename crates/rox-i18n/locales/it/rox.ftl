...
settings-appearance-chrome-side = Lato dei pulsanti finestra
    .description = A quale estremità della barra del titolo di rox stanno i pulsanti; disegnata solo dove il compositor non decora la finestra
...
settings-appearance-chrome-style = Stile dei pulsanti finestra
    .description = Come vengono disegnati i pulsanti sulla barra del titolo di rox; disegnata solo dove il compositor non decora la finestra
