...
library-empty-note = Verrà scansionata nella libreria (flac, mp3, ogg, opus, m4a, aac, wav, aiff)
...
stations-checking = Controllo dello stream...
stations-is-hls = Questa è una playlist di segmenti HLS; rox riproduce un solo stream continuo
stations-is-a-playlist = Questa è una lista di stazioni; leggila con Importa stazioni
stations-not-audio = Quell'URL risponde con { $kind }, non con audio
stations-added-unchecked = Aggiunta senza controllo: lo stream non ha risposto ({ $reason })
...
settings-appearance-chrome-side = Lato dei pulsanti finestra
    .description = A quale estremità della barra del titolo di rox stanno i pulsanti; disegnata dove il compositor non decora la finestra e sulle finestre secondarie senza cornice
settings-appearance-chrome-side-left = Sinistra
settings-appearance-chrome-side-right = Destra
settings-appearance-chrome-style = Stile dei pulsanti finestra
    .description = Come vengono disegnati i pulsanti sulla barra del titolo di rox; disegnata dove il compositor non decora la finestra e sulle finestre secondarie senza cornice
settings-appearance-cjk-fonts-note = Il testo giapponese, cinese o coreano della tua libreria prova uno per uno tutti i font installati. Lo scorrimento rallenta e il testo appare in un font sostitutivo. Installa i font Noto Sans CJK statici: noto-fonts-cjk-sans-static su NixOS, google-noto-sans-cjk-fonts su Fedora, noto-fonts-cjk su Arch, fonts-noto-cjk su Debian.
settings-appearance-cjk-fonts-title = Nessun font CJK di peso normale
...
settings-appearance-bare-child-windows = Finestre secondarie senza cornice
    .description = Con le decorazioni di sistema disattivate, anche impostazioni, editor e pannelli staccati perdono la cornice di sistema e disegnano la barra del titolo di rox; il bordo di ridimensionamento vale anche per loro
settings-appearance-child-titlebar = Barra del titolo delle finestre secondarie
    .description = La barra del titolo che rox disegna sulle finestre secondarie senza cornice; disattivata, restano senza nulla attorno e la scorciatoia Chiudi finestra le chiude
...
settings-integrations-discord-first-line = Prima riga
    .description = La prima riga della scheda, sotto rox, e ciò che l'elenco dei membri ripete per impostazione predefinita
settings-integrations-discord-hover-line = Tooltip della copertina
    .description = Il testo dietro la copertina, al passaggio del puntatore. Vuoto lascia la copertina senza tooltip
settings-integrations-discord-line-off = Vuota, quindi la scheda lascia fuori questa riga
settings-integrations-discord-line-preview = Anteprima: { $line }
settings-integrations-discord-second-line = Seconda riga
    .description = La seconda riga della scheda. Lasciala vuota per toglierla dalla scheda
...
settings-integrations-discord-status-line = Riga di stato
    .description = Ciò che Discord mostra accanto al tuo nome nell'elenco dei membri
settings-integrations-discord-status-line-app = Nome dell'app
settings-integrations-discord-status-line-first = Prima riga
settings-integrations-discord-status-line-second = Seconda riga
...
settings-integrations-subsonic-name = Nome
    .description = Come rox chiama questo server; finché è vuoto, al suo posto c'è l'indirizzo
settings-integrations-subsonic-name-placeholder = Casa
settings-integrations-subsonic-new = Nuovo server
settings-integrations-subsonic-password-placeholder = Password
settings-integrations-subsonic-remove = Rimuovi server
    .description = Dimentica l'accesso a questo server ed elimina le sue tracce dalla libreria; disattivarlo le conserva, nascoste
...
settings-integrations-subsonic-use = Usa questo server
    .description = Legge la sua libreria e riproduce da lì; disattivato, le sue tracce restano nella libreria, nascoste
...
settings-library-add-folder = Cartella...
settings-library-add-subsonic = Server Subsonic...
settings-library-col-source = Sorgente
settings-library-duplicates = Duplicati...
settings-library-embed-button = Incorpora i metadati salvati...
settings-library-exclude-col = Esclusi
settings-library-exclude-intro = File e cartelle che la libreria lascia fuori da tutte le sorgenti qui sopra. Un nome come *.tmp corrisponde ovunque, e un percorso come Live/** parte dalla cima di ogni cartella. Maiuscole e minuscole non contano, e una cartella che corrisponde viene saltata per intero. I file restano dove sono
settings-library-exclude-invalid = Impossibile leggere quel modello: { $reason }
settings-library-exclude-none = Niente escluso
settings-library-exclude-nudge = Modelli cambiati: il monitoraggio si adegua subito. Le tracce già nella libreria restano finché non premi Riscansiona nell'intestazione Sorgenti
settings-library-exclude-placeholder = *.tmp o Live/**
...
settings-library-folders-intro = Cartelle e server da cui si legge la libreria; rimuoverne uno toglie le sue tracce dal catalogo e lascia stare i file di una cartella
settings-library-genre-separator-nudge = Separatori cambiati: la navigazione si adegua subito. Le liste di generi salvate da scansioni precedenti tengono la vecchia forma finché non premi Riscansiona nell'intestazione Sorgenti
...
settings-library-no-sources = Ancora nessuna sorgente
...
settings-library-section-sources = Sorgenti
...
settings-playback-live-buffer-cap = Il buffer si ferma a { $cap } per quanto lunga sia l'impostazione: un decimo della memoria di questa macchina.
...
settings-playback-capture-buffer-title = Il buffer della diretta è più corto della maggior parte dei brani
settings-playback-capture-buffer-note = È a { $buffer }, e un brano viene salvato solo se alla fine sta ancora tutto nel buffer. { $default } copre quasi tutto quello che passa una stazione.
...
settings-playback-capture-pattern-source = %source% è il tipo di sorgente da cui arriva il flusso, così un tipo nuovo finisce in una cartella tutta sua.
...
settings-confirm-remove-subsonic-body = L'accesso viene dimenticato e le sue tracce escono dalla libreria. Per riaverle bisogna collegarsi e sincronizzare di nuovo; disattivarlo invece le conserva.
settings-confirm-remove-subsonic-title = Rimuovere "{ $name }"?
...
autoeq-save = Salva
autoeq-saved = Salvato
autoeq-saved-info = Salvato come "{ $name }"
autoeq-save-failed = Impossibile scrivere il file di preset
autoeq-applied-info = Applicato: { $name } ({ $source })
autoeq-applied-info-preamp = Applicato: { $name } ({ $source }), preamplificazione { $db } dB
autoeq-imported-info = Importato: { $name }
autoeq-imported-info-preamp = Importato: { $name }, preamplificazione { $db } dB
autoeq-read-failed = Impossibile aprire il file: { $reason }
autoeq-parse-failed = Impossibile leggere il profilo: { $reason }
autoeq-import-untitled = Personalizzato
...
eq-preset-export = Esporta
eq-preset-export-default = Equalizzatore
eq-preset-name = Nome del preset
eq-preset-save = Salva preset
eq-presets = Preset
...
keymap-cue-clear = Cancella punti
    .description = Togliere tutti i punti di sessione dal brano in riproduzione
...
lastfm-import-history = Lettura della cronologia degli scrobble
...
tags-editor-guess-help = / corrisponde alla cartella sopra, %skip% scarta
...
tags-guess-placeholders = Segnaposto
...
tags-rename-pattern-help = / crea una cartella dalla radice della libreria, senza / rinomina sul posto, l'estensione segue il file
...
convert-dialog-pattern-help = / crea una cartella, il formato imposta l'estensione
...
lyrics-build-word-by-word = Segui le parole cantate
    .description = Fa correre una testina di lettura lungo la riga attiva, sui tempi di parola del foglio quando li ha
...
lyrics-head-build = Costruzione
lyrics-head-fill = Riempimento
lyrics-hide-upcoming = Nascondi le righe successive
    .description = Tiene fuori vista ogni riga che la testina non ha ancora raggiunto, così il foglio si scopre mentre suona
...
lyrics-read-head-style = Testina di lettura
    .description = Come la riga attiva mostra la testina: un riempimento karaoke che la attraversa, o ogni parola che si costruisce a turno
...
lyrics-unsung-dim = Attenuazione del non cantato
    .description = Quanto il riempimento smorza la parte della riga attiva non ancora cantata
lyrics-wipe-lyrics = Cancella i testi
lyrics-wrap-lines = Manda a capo le righe lunghe
    .description = Lascia che una riga troppo larga per il pannello prosegua su un'altra riga invece di essere tagliata
...
player-stream-refused = Traccia saltata: { $reason }
