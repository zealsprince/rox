...
settings-appearance-chrome-side = Lado dos botões da janela
    .description = Em que ponta da barra de título própria do rox os botões ficam; só é desenhada onde o compositor não decora a janela
...
settings-appearance-chrome-style = Estilo dos botões da janela
    .description = Como os botões da barra de título própria do rox são desenhados; só é desenhada onde o compositor não decora a janela
