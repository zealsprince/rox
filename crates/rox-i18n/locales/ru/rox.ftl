...
settings-appearance-chrome-side = Сторона кнопок окна
    .description = С какого края собственного заголовка rox стоят кнопки; рисуется только там, где композитор не оформляет окно
...
settings-appearance-chrome-style = Стиль кнопок окна
    .description = Как рисуются кнопки на собственном заголовке rox; рисуется только там, где композитор не оформляет окно
