...
align-row = Выравнивание
    .description = Где стоит содержимое, когда у панели есть запас места
valign-row = Вертикальное выравнивание
    .description = Где стоит содержимое, когда у панели есть запас высоты
valign-top = Сверху
...
signal-response-drift = 0 держится музыки вплотную, 100 тянется за ней
...
signal-threshold-gate = Ниже этого сигнал читается как ноль, а выше выход снова растёт от нуля, так что тихие места не двигают регулятор. Метка на индикаторе выше показывает, где стоит порог
signal-low-bound = Нижняя граница
signal-high-bound = Верхняя граница
signal-adds-up = Что суммируется
    .description = Какой сигнал здесь накапливается; сумма растёт, пока тот стоит высоко, и замирает, пока он тихий
...
signal-aggregate-unpicked = Ничего не выбрано, поэтому сумма стоит на нуле. Выберите сигнал выше.
...
signal-reset-on-track = Сброс на новом треке
    .description = Стекать к нулю, когда начинается новая песня, чтобы фаза не тащила в неё сумму прошлой
...
route-quiet = Тишина
    .description = Чего достигает регулятор в тишине, как доля от собственной настройки
route-loud = Громко
    .description = Чего он достигает при полном сигнале; 100% это собственное значение ползунка, ниже Тишины модуляция идёт вниз
route-slot = Слот
    .description = Какой из шестнадцати сигнальных слотов шейдера заполняет этот маршрут
route-slot-quiet-description = Что слот читает в тишине
route-slot-loud-description = Что он читает при полном сигнале; ниже Тишины слот идёт задом наперёд
route-slot-signal-description = За каким общим сигналом идёт этот маршрут
route-slot-signal-gone = Сигнал этого маршрута пропал; слот читает ноль, пока не выбран другой.
...
route-no-signals-yet = Следить пока не за чем, сигналов нет. Создайте сигнал, и он появится здесь; до тех пор слот читает ноль.
...
panel-locked = Закреплена
    .description = Закрепить панель на месте; док не даст её перетащить или переставить
...
panel-run-when-idle = Работать в простое
    .description = Продолжать рисовать кадры, пока звук молчит. Если выключено, шейдер замирает там, где стоит, и панель ничего не стоит
...
playback-item-play = Воспроизведение
...
shader-note-file = { $path }. Ваши сохранения перезагружаются прямо во время рисования, а исходник хранится внутри макетов и наборов, так что переживёт машину, на которой файла никогда не было.
...
library-headers = Заголовки
    .description = Разрывы групп поверх списка; сортировка сохраняет цельность серий, а поиск рисует список плоским
...
library-header-row = Строка заголовка
    .description = Что помещается в однострочный заголовок слева направо; распорка или разделитель разводит стороны
...
library-line-height = Высота строки
...
library-flush-background = Фон заподлицо
    .description = Посадить заголовки на фон списка вместо приподнятого оттенка; окраска по треку двигает их вместе
...
library-art-description = Плитка развёрнутых заголовков: обложка, портрет исполнителя или лицо жанра
library-art-rounding = Скругление обложки
    .description = Скруглить углы обложки
library-art-position = Положение обложки
    .description = С какой стороны блока стоит плитка развёрнутых заголовков
...
grid-show-titles = Показывать названия
...
settings-appearance-backdrop-all-windows = Все окна
    .description = Подкладывать фон и под дочерние окна: настройки, редакторы, диалоги, отделённые панели. Выключено оставляет подложку и прозрачность окнам рабочего пространства
...
settings-appearance-design-mode = Режим дизайна
    .description = Правка макета прямо на месте: пункты меню панели для добавления, переименования, дублирования, отделения и закрытия, элементы, которые контейнер накладывает на свои слоты, и перетаскивание вкладок. Выключено прячет всё это; страница «Рабочее пространство» по-прежнему правит дерево
...
settings-appearance-hide-menubar = Скрывать строку меню
    .description = Держать строку меню скрытой и выводить её над доком, пока зажат Alt. Двойное нажатие Alt оставляет её на экране, и тогда её кнопки берут обычный клик
...
settings-appearance-os-decorations = Оформление окон ОС
    .description = Заголовок и рамки от ОС на основных окнах; выключено опирается на кнопки окна и панели с областью перетаскивания
...
settings-appearance-panel-seams = Швы панелей
    .description = Волосяная линия между плитками панелей; выключено оставляет манипуляторы размера невидимыми, но тянуть их всё равно можно
...
settings-audio-exclusive-mode = Монопольный режим
    .description = Забрать устройство только для rox и гонять его на собственной частоте файла там, где железо это принимает; выключено делит системный микшер со всем остальным на рабочем столе
settings-audio-fade-inside-albums = Затухание внутри альбомов
    .description = Перекрывать и треки, которые принадлежат одной записи. Выключено сохраняет собственные склейки записи ровно такими, какими их свели, а это как раз то место, где отсутствие пауз важнее всего
...
settings-audio-replaygain-level-by = Выравнивать по
    .description = Играть каждый трек на той громкости, которую намерили его теги ReplayGain, чтобы перемешивание перестало прыгать между мастерингами. Трек меряет каждый файл сам по себе; Альбом берёт усиление записи по всем её трекам, и это оставляет собственные тихие и громкие места альбома там, где их поставили
...
settings-audio-replaygain-measure-new = Измерять новые файлы
    .description = Мерить то, что приносит наблюдатель за папками, по мере поступления, когда синхронизация утихла, чтобы растущая медиатека держала свои усиления без похода сюда. Числа ложатся туда, куда указывает «Куда сохранять измеренное». Включение сначала предложит измерить то, чего уже не хватает; дальше видны только что появившиеся файлы
...
settings-audio-replaygain-save = Куда сохранять измеренное
    .description = Куда проход измерения кладёт свои числа. База медиатеки оставляет ваши файлы нетронутыми; теги кладут те же значения туда, где их читает любой другой плеер, ценой перезаписи звуковых файлов
settings-audio-replaygain-status-measured = У всех { $total } просканированных треков есть усиление для выравнивания, из них { $measured } измерил rox
settings-audio-replaygain-status-tagged = Все { $total } просканированных треков несут теги ReplayGain
...
settings-integrations-lastfm-love-pending = { $hearts } ждут отправки
settings-integrations-lastfm-love-pending-failed = { $hearts } ждут отправки, последняя попытка: { $error }
...
settings-integrations-lastfm-working = Работаем...
...
## Settings: library
settings-library-acoustic-all-described = { $label } описывает все { $total } просканированных треков
settings-library-acoustic-auto = Описывать новые файлы
    .description = Описывать то, что приносит наблюдатель за папками, по мере поступления, когда синхронизация утихла, чтобы растущая медиатека держала свои описания без похода сюда. Если выключено, новые файлы ждут кнопки «Проанализировать недостающее». Включение сначала предложит проанализировать то, чего уже не хватает; дальше видны только что появившиеся файлы
...
settings-library-acoustic-progress = { $running } на { $done } из { $total }
settings-library-acoustic-progress-start = { $running }: разбираем, чего не хватает...
settings-library-acoustic-save = Куда сохранять описания
    .description = Куда проход кладёт то, что разобрал. Одна база оставляет ваши файлы нетронутыми; теги кладут копию ещё и в каждый файл, так что описания переживут пересборку базы или переезд папки на другую машину, ценой перезаписи звуковых файлов. Теги достают только до MP3 и FLAC, у остальных форматов остаётся копия в базе
...
settings-library-merge-case = Объединять варианты регистра
    .description = Считать значения, различающиеся только регистром, одним и тем же: Rock и rock становятся одним жанром, исполнителем и альбомом и показываются в том написании, которое несёт больше треков. В файлах теги остаются как есть
...
settings-library-split-genres = Делить жанры по запятым и слэшам
    .description = «Dubstep, Trap» и «Drum & Bass / Neurofunk» дают каждому значению отдельный жанр; точка с запятой делит всегда. Выключено оставляет имена со слэшем целыми там, где они означают один жанр. В файлах теги остаются как есть
settings-library-tempo-auto = Считать темп новых файлов
    .description = Считать удары в том, что приносит наблюдатель за папками, по мере поступления, когда синхронизация утихла, чтобы растущая медиатека держала свои темпы без похода сюда. Если выключено, новые файлы ждут кнопки «Проанализировать недостающее». Включение сначала предложит посчитать то, чего уже не хватает; дальше видны только что появившиеся файлы
...
settings-library-tempo-progress = Обработано { $done } из { $total }
settings-library-tempo-progress-start = Разбираемся, чего не хватает...
settings-library-tempo-status-measured = У всех { $total } просканированных треков есть темп, из них { $measured } определил rox
settings-library-tempo-status-tagged = Все { $total } просканированных треков несут тег темпа
...
settings-library-write-stored = Записать сохранённое в сами файлы
    .description = Три настройки сохранения действуют только на следующую запись, так что всё, сохранённое до переключения на «Теги», лежит только в rox. Здесь тексты, усиления и описания, которые rox уже хранит, записываются в сами файлы, чтобы папка, отданная другому плееру, несла их с собой. Ничего не пересчитывается
...
settings-mlmodels-custom-description-empty = Укажите rox свой чекпоинт PANNs CNN10 в формате safetensors. Он читается на месте и именуется по своему хешу, так что второй чекпоинт описывает медиатеку отдельно, а не ложится в координаты первого
...
settings-mlmodels-stopping = Останавливаем скачивание { $label }...
...
settings-providers-save-lyrics = Куда сохранять найденные тексты
    .description = Куда ложится найденный текст: в собственную папку данных rox, оставляя медиатеку чистой, в файл .lrc рядом с треком или во встроенный тег
...
settings-shader-backdrop-all-windows = Все окна
    .description = Затенять подложку каждого окна: настройки, редакторы, диалоги, отделённые панели. Выключено оставляет это окнам рабочего пространства
...
settings-shader-backdrop-run-idle = Работать в простое
    .description = Продолжать рисовать, когда ничего не играет. Анимация в любом случае остаётся на месте
settings-shader-compile-error-title = Этот шейдер не скомпилировался
settings-shader-legacy-note = Если ничего не назначено, пул кормит слоты в собственном порядке: первый сигнал в слот 0, второй в слот 1 и так далее. Первый же добавленный маршрут забирает всю раздачу на себя.
...
settings-shader-screen-run-idle = Работать в простое
    .description = Продолжать рисовать, когда ничего не играет. Анимация в любом случае остаётся на месте. Шейдер, который читает мышь, следует за курсором и с остановленной музыкой без этой настройки; он просто замирает через пару секунд после указателя
...
settings-shader-slots-block = Слоты
    .description = Каждый слот в том виде, в каком он доходит до шейдера; слоты без маршрута это регуляторы, выставленные вручную
...
settings-storage-looks-layouts = Внешний вид и макеты
    .description = Внешний вид, в котором сейчас ходит приложение (workspace.json), рядом с сохранёнными рабочими пространствами, выгруженными файлами шейдеров и наборами значков. Мало места, и каждый байт здесь настроен вами
...
settings-storage-measured-tempos = Измеренные темпы
    .description = Темпы, которые rox насчитал из звука для треков, у которых их нет в тегах; собственные числа тегов не трогаются. Очистка вернёт эти треки в список «Проанализировать недостающее» на странице «Медиатека», и именно так улучшенный счёт ударов доходит до чисел, записанных прошлым проходом
...
settings-storage-models-empty = Модели
    .description = Медиатеку ещё ничто не описывало. Заполняет это включение акустического анализа на странице «Медиатека», и каждая отработавшая модель получает здесь строку
...
settings-workspace-composition-hint = Панели окна так, как они стоят в разделителях и группах вкладок; стрелки меняют порядок строки среди соседей, замок закрепляет панель на месте, а шестерёнка открывает её настройки
...
settings-development-experimental-panels = Экспериментальные панели
    .description = Показывать ещё строящиеся панели в меню «Панели» и в лаунчере; они меняют форму от выпуска к выпуску, а макет, в котором такая панель уже стоит, сохранит её после выключения этой настройки
...
settings-confirm-clear-embeddings-body = Описания уйдут, место вернётся. Чтобы получить их снова, проходу анализа придётся заново прослушать каждый трек в медиатеке.
settings-confirm-clear-embeddings-title = Очистить то, что описала «{ $model }»?
settings-confirm-clear-measured-bpm-body = Каждый темп, который посчитал rox, вернётся в состояние «не измерено»; числа из тегов ваших файлов останутся. Чтобы получить их снова, проходу темпа придётся заново декодировать все эти треки.
...
workspace-apply-shaders-approve-body = Подтверждение позволит им работать на этой машине. Если применить без них, внешний вид останется голым, а шейдеры так и будут лежать в его пуле.
workspace-apply-shaders-plain-body = Если применить без них, внешний вид останется голым, а шейдеры так и будут лежать в его пуле.
...
workspace-launcher-hint = Добавьте первую панель, чтобы начать сборку, или возьмите готовое в «Рабочее пространство > Применить рабочее пространство»
...
## Tasks window
tasks-acoustic-all-described = { $label } описывает все { $count } просканированных треков
...
tasks-import-unmatched = { $count } не нашли совпадения в этой медиатеке
...
tasks-rg-all-gain = У всех { $count } треков есть усиление для воспроизведения
...
tasks-scan-no-folders = Пока не добавлено ни одной папки. Откройте её из меню «Файл»
...
tasks-tempo-all = У всех { $count } треков есть темп
...
stats-show-change = Показывать изменение
    .description = Добавить значок с тем, как окно смотрится против предыдущего, вверх или вниз; у «За всё время» позади ничего нет
stats-show-number = Показывать число
    .description = Рисовать счётчик рядом со значком; выключено оставляет голый значок, а числа появляются при наведении
...
welcome-design-mode-note = Для перестановки нужен режим дизайна, он включён по умолчанию наверху того меню. Выключенный, он запирает макет, так что готовую сборку не сдвинуть случайно.
welcome-done = Готово
...
welcome-stage-lead-quick-start = Выберите рабочее пространство, и основное окно наденет его: макеты, палитру, весь внешний вид.
...
welcome-tour-intro = Короткий тур: откуда приходит музыка и где живёт внешний вид. Он заканчивается полкой готовых рабочих пространств, каждое в один клик.
...
signals-blurb-shared = Настроенное здесь общее: изменение доходит до каждого параметра, направленного на этот сигнал, в каждой панели и каждом окне.
signals-blurb-total = Сумма это четвёртый вид: она накапливает другой сигнал со временем и сбрасывается на 1, поэтому растёт, пока музыка громкая, и замирает, пока нет. Пригодится, когда шейдеру нужна фаза, которая движется с песней, а не с часами.
...
eq-band-badge = Значок полос
    .description = Считать полосы, сдвинутые с нуля, на значке поверх иконки
eq-band-label = Полоса { $number }
eq-click-nothing = Ничего
eq-click-open = Открыть
eq-click-section = Клик
    .description = Что делает клик: открывает окно эквалайзера или включает и выключает всю кривую там, где она стоит
eq-click-toggle = Переключить
eq-flatten = Выровнять
eq-freq-label = Частота
eq-gain-label = Усиление
eq-heading = Эквалайзер
eq-help-text = Тяните полосу, чтобы её сдвинуть, крутите колесо над ней, чтобы расширить или сузить. Обработка стоит перед буфером, который кормит звуковую карту, поэтому движение доходит до колонок примерно за полсекунды.
...
keymap-toggle-post-shader = Переключить шейдер наложения
    .description = Выключить и включить экранный шейдер. Назначено везде намеренно: шейдер может похоронить под собой любой элемент, через который иначе добираются до этого сочетания
...
updater-short = загрузка остановилась на { $done } из { $bytes } байт
...
lastfm-import-stopped = Остановлено после { $count } любимых треков
...
tags-editor-unread-count = Не удалось прочитать теги { $failed } файлов из { $total }
...
tags-matcher-tagging = Проставляем теги: { $track }
...
tags-rename-move-errors = { $count } файлов не удалось; { $error }
...
tags-rename-will-move = переместится { $count } из { $total }
...
tags-repair-result-failed = Починено { $count }, не удалось { $failed }
...
convert-custom-ext-empty = Контейнер выбирается расширением, так что оно нужно
...
convert-dialog-checking = Спрашиваем ffmpeg...
...
convert-dialog-custom-note = Аргументы делятся по пробелам, кавычек нет; встроенные обложки для своих форматов не переносятся
...
convert-dialog-pick-folder = Выберите папку для записи
convert-dialog-span-note = { $count } вырезано из образа cue и снабжено тегами из медиатеки
convert-dialog-will-convert = преобразуется { $count } из { $total }
...
convert-flag-f = Контейнер выбирается расширением, так что -f задавать нельзя
...
convert-summary-failed = , не удалось { $count }
...
convert-summary-stopped = Остановлено после { $files } в { $dest }
convert-version-answered = { $binary } ответил
...
duplicates-trash-result-failed = В корзину отправлено { $count }, не удалось { $failed }
...
smart-playlist-unknown-field = «{ $field }:» это не поле, поэтому терм ищется как обычный текст
...
cover-disc-style = Стиль диска
    .description = Одеть изображение как компакт-диск или как этикетку винила
...
cover-editor-save-errors = { $count } файлов не удалось; { $error }
...
cover-matcher-blocked-fetching = Скачиваем полное изображение...
...
cover-matcher-setting = Устанавливаем...
...
lyrics-build-word-by-word = Собирать по словам
    .description = Открывать слова по мере того, как их поют, как в караоке; неспетые строки ждут скрытыми
...
lyrics-font = Гарнитура текста песни; по умолчанию следует шрифту приложения
...
lyrics-lead-in-rest = Отдых перед вступлением
    .description = Стоять на пустом отдыхе перед длинным вступлением, чтобы первая строка проявилась, когда дойдёт до неё
lyrics-line-falloff = Затухание строк
    .description = Насколько каждая строка тускнеет с каждым шагом от активной
lyrics-line-spacing = Интервал строк
    .description = Насколько далеко друг от друга стоят синхронизированные строки, кратно размеру текста
...
pass-acoustic-lands-tags = Результаты идут в базу медиатеки, а для MP3 и FLAC ещё и в теги каждого файла, так что переживут пересборку базы. У остальных форматов остаётся только копия в базе.
...
drawer-handle = Ручка
    .description = Показывать зацеп у края панели. Скрытая, она не показывает от ящика ничего до выбора, а потом остаётся, пока выбор держится, так что закрывшийся ящик можно вытянуть обратно
...
shader-panel-note-off-body = Исходник и его привязки на месте, просто стоят.
shader-panel-note-off-title = Этот шейдер выключен.
shader-panel-note-pending-body = Он пришёл с макетом или рабочим пространством, а не с этой машины, поэтому стоит на месте, пока вы его не просмотрите.
...
shader-panel-run-shader = Выполнять шейдер
    .description = Выключенный, он держит исходник, закладку и привязки на месте и ничего не рисует
...
genre-grid-merge-many = Объединить { $count } жанров в «{ $target }»
genre-grid-merge-one = Объединить «{ $source }» с «{ $target }»
genre-grid-pick-filters = Выбор фильтрует медиатеку
    .description = Клик по жанру сужает до него каждую панель, следящую за общим поиском; выключено оставляет клик обычным выбором
...
genre-grid-tile-face = Лицо плитки
...
artist-grid-pick-filters = Выбор фильтрует медиатеку
    .description = Клик по исполнителю сужает до него каждую панель, следящую за общим поиском; выключено оставляет клик обычным выбором
artist-grid-play-artists = Воспроизвести исполнителей: { $count }
artist-grid-portraits = Портреты исполнителей
    .description = Показывать собственное фото исполнителя, найденное один раз на имя и сохранённое на диск; выключено показывает обложку первого альбома
...
art-disc-style = Стиль диска
    .description = Одеть каждую обложку как компакт-диск или как этикетку винила
...
biography-fill-width = На всю ширину
    .description = Дать высокой шапке занять всю ширину вместо ограниченной и центрированной
...
biography-looking-up = Ищем { $name }
...
biography-similar-artists = Похожие исполнители
    .description = Имена, к которым тянется смежное прослушивание, внизу
...
biography-tags = Теги
    .description = Жанровые теги строкой значков
...
status-readouts = Показания
    .description = Тяните вдоль полосы, чтобы менять порядок; тяните между строками либо жмите x и плюс на значке, чтобы скрывать и показывать
...
output-detail-label = Детализация
    .description = Значок держит всё в одном ярлыке, остальное показывает при наведении; компактный даёт заголовку отдельную строку, для полосы вдоль края; развёрнутый добавляет причины рядом, а в узкой панели под ним
output-device-name = Имя устройства
    .description = Называть работающее устройство в заголовке; выключено оставляет в строке режим, частоту и формат
...
search-filter-chips = Значки фильтров
...
## Track info panel
track-info-color-output-chip = Цветной значок вывода
    .description = Разрешить значку окрашиваться в предупреждающие цвета, когда вывод откатывается или пересчитывает частоту. Выключено держит его всегда в одном приглушённом тоне, а подсказка при наведении всё равно объясняет состояние
track-info-cycle-every = Менять каждые
    .description = Сколько держится каждая строка перед сменой
...
## Volume panel
volume-pieces = Части
    .description = Тяните вдоль полосы, чтобы менять порядок; тяните между строками либо жмите x и плюс на значке, чтобы скрывать и показывать. Если проценты скрыты, их несёт подсказка динамика
...
transport-pieces = Части
    .description = Тяните вдоль строки, чтобы менять порядок, и между строками, чтобы переносить; x и плюс на значке скрывают и показывают
...
pace-half-hours = около { $value } часов
pace-days = { $count ->
    [one] около { $count } дня
...
workspace-shipped-diffuse-blurb = Только играющий альбом: обложка и карточка воспроизведения одной группой на всё окно, прозрачные поверхности над подложкой, без швов. Медиатека, очередь и текст песни ждут в ящике у правого края и выезжают поверх музыки, когда на ручку наводят курсор. Монохром намеренно: цвет несут обложки.
