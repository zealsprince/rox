...
library-empty-note = Вона потрапить у медіатеку при скануванні (flac, mp3, ogg, opus, m4a, aac, wav, aiff)
...
stations-checking = Перевірка потоку...
stations-is-hls = Це список сегментів HLS; rox грає один неперервний потік
stations-is-a-playlist = Це список станцій; відкрийте його через Імпортувати станції
stations-not-audio = Цей URL відповідає { $kind }, а не аудіо
stations-added-unchecked = Додано без перевірки: потік не відповів ({ $reason })
...
settings-appearance-chrome-side = Сторона кнопок вікна
    .description = З якого краю власного заголовка rox стоять кнопки; малюється там, де композитор не оформлює вікно, і на дочірніх вікнах без рамки
settings-appearance-chrome-side-left = Ліворуч
settings-appearance-chrome-side-right = Праворуч
settings-appearance-chrome-style = Стиль кнопок вікна
    .description = Як малюються кнопки на власному заголовку rox; малюється там, де композитор не оформлює вікно, і на дочірніх вікнах без рамки
settings-appearance-cjk-fonts-note = Для японського, китайського й корейського тексту у вашій бібліотеці по черзі перебираються всі встановлені шрифти. Через це прокручування гальмує, а текст малюється запасним шрифтом. Установіть статичні шрифти Noto Sans CJK: noto-fonts-cjk-sans-static у NixOS, google-noto-sans-cjk-fonts у Fedora, noto-fonts-cjk в Arch, fonts-noto-cjk у Debian.
settings-appearance-cjk-fonts-title = Немає шрифту CJK звичайної товщини
...
settings-appearance-bare-child-windows = Дочірні вікна без рамки
    .description = З вимкненим Оформленням ОС налаштування, редактори й винесені панелі теж втрачають рамку ОС і малюють власний заголовок rox; Рамка зміни розміру діє й на них
settings-appearance-child-titlebar = Заголовок дочірніх вікон
    .description = Заголовок, який rox малює на дочірніх вікнах без рамки; вимкнено, довкола них нічого не лишається, а закриває їх комбінація «Закрити вікно»
...
settings-integrations-discord-first-line = Перший рядок
    .description = Перший рядок картки, під rox, і те, що список учасників повторює за замовчуванням
settings-integrations-discord-hover-line = Підказка обкладинки
    .description = Текст за обкладинкою, коли навести вказівник. Порожньо — обкладинка без підказки
settings-integrations-discord-line-off = Порожньо, картка обходиться без цього рядка
settings-integrations-discord-line-preview = Перегляд: { $line }
settings-integrations-discord-second-line = Другий рядок
    .description = Другий рядок картки. Залиште порожнім, і його не буде на картці
...
settings-integrations-discord-status-line = Рядок статусу
    .description = Що Discord показує біля вашого імені у списку учасників
settings-integrations-discord-status-line-app = Назва застосунку
settings-integrations-discord-status-line-first = Перший рядок
settings-integrations-discord-status-line-second = Другий рядок
...
settings-integrations-subsonic-name = Назва
    .description = Як rox називає цей сервер; поки поле порожнє, замість нього показується адреса
settings-integrations-subsonic-name-placeholder = Дім
settings-integrations-subsonic-new = Новий сервер
settings-integrations-subsonic-password-placeholder = Пароль
settings-integrations-subsonic-remove = Вилучити сервер
    .description = Забути вхід на цей сервер і видалити його треки з медіатеки; якщо вимкнути, треки лишаться, але приховані
...
settings-integrations-subsonic-use = Використовувати цей сервер
    .description = Читати його медіатеку і грати з нього; якщо вимкнути, треки лишаться в медіатеці, але приховані
...
settings-library-add-folder = Тека...
settings-library-add-subsonic = Сервер Subsonic...
settings-library-col-source = Джерело
settings-library-duplicates = Дублікати...
settings-library-embed-button = Вписати збережені метадані...
settings-library-exclude-col = Виключено
settings-library-exclude-intro = Файли й теки, які медіатека пропускає в усіх джерелах вище. Назва на кшталт *.tmp збігається будь-де, а шлях на кшталт Live/** рахується від верху кожної теки. Регістр не важить, а теку, що збіглася, пропущено цілком. Самі файли лишаються на місці
settings-library-exclude-invalid = Не вдається прочитати шаблон: { $reason }
settings-library-exclude-none = Нічого не виключено
settings-library-exclude-nudge = Шаблони змінилися: стеження підхопить це одразу. Треки, що вже є в медіатеці, лишаються, поки ви не натиснете Пересканувати вгорі, у заголовку Джерела
settings-library-exclude-placeholder = *.tmp або Live/**
...
settings-library-folders-intro = Теки й сервери, з яких читається медіатека; прибране джерело прибирає свої треки з каталогу, а файли теки лишає на місці
settings-library-genre-separator-nudge = Роздільники змінилися: перегляд підхопить це одразу. Списки жанрів, збережені попередніми скануваннями, тримають стару форму, поки ви не натиснете Пересканувати вгорі, у заголовку Джерела
...
settings-library-no-sources = Ще немає джерел
...
settings-library-section-sources = Джерела
...
settings-library-subsonic-add-note = Підходить Navidrome, Airsonic, gonic і будь-який інший сервер з API Subsonic
settings-library-subsonic-add-title = Додати сервер Subsonic
...
settings-playback-live-buffer-cap = Буфер зупиняється на { $cap }, хоч би яку довжину було задано: десята частина пам'яті цієї машини.
...
settings-playback-capture-buffer-title = Буфер ефіру коротший за більшість пісень
settings-playback-capture-buffer-note = Зараз { $buffer }, а пісня зберігається, лише якщо наприкінці вона цілком лишилася в буфері. { $default } вистачає майже на все, що ставлять станції.
...
settings-playback-capture-pattern-source = %source% позначає тип джерела, звідки йде потік, тож новий тип джерела потрапляє до власної теки.
...
settings-playback-section-streaming = Стримінг
...
settings-storage-listening-history = Історія прослуховувань
    .description = Кожне відтворення, про яке знає бібліотека: власні та все, що приніс імпорт із Last.fm. Звідси беруться стовпець відтворень, вікно статистики, панель історії й будь-який розумний список, що сортує за відтвореннями
...
settings-common-remove = Вилучити
...
settings-confirm-remove-subsonic-body = Вхід буде забуто, а треки сервера зникнуть із медіатеки. Щоб повернути їх, доведеться знову підключитися й синхронізувати; вимкнення натомість їх зберігає.
settings-confirm-remove-subsonic-title = Вилучити «{ $name }»?
...
## статистики та сторінка сховища, і число в їхніх рядках.

listens-clear-body = { $imported } з { $total } прослуховувань надійшли з імпорту Last.fm: з датою там, де її знав обліковий запис, і розкидані по роках там, де лишилося саме число. Очистити лише їх означає зберегти прослуховування, які rox бачив сам; очистити все означає лишити бібліотеку без історії.
listens-clear-body-plain = { $listens }, жодного з імпорту: rox бачив кожне сам. Очищення лишить бібліотеку без історії.
listens-clear-button = Очистити історію
listens-clear-everything = Очистити все
listens-clear-imported = Очистити імпортовані
listens-clear-title = Очистити історію прослуховувань?
listens-count = { $count ->
    [one] { $count } прослуховування
    [few] { $count } прослуховування
    [many] { $count } прослуховувань
...
autoeq-save = Зберегти
autoeq-saved = Збережено
autoeq-saved-info = Збережено як «{ $name }»
autoeq-save-failed = Не вдалося записати файл пресету
autoeq-applied-info = Застосовано: { $name } ({ $source })
autoeq-applied-info-preamp = Застосовано: { $name } ({ $source }), попереднє підсилення { $db } дБ
autoeq-imported-info = Імпортовано: { $name }
autoeq-imported-info-preamp = Імпортовано: { $name }, попереднє підсилення { $db } дБ
autoeq-read-failed = Не вдалося відкрити файл: { $reason }
autoeq-parse-failed = Не вдалося прочитати профіль: { $reason }
autoeq-import-untitled = Власний профіль
...
eq-preset-export = Експорт
eq-preset-export-default = Еквалайзер
eq-preset-name = Назва пресету
eq-preset-save = Зберегти пресет
eq-presets = Пресети
...
keymap-cue-clear = Очистити позначки
    .description = Прибрати всі сеансові позначки з треку, що грає
...
lastfm-import-history = Читаємо історію скроблів
...
tags-editor-guess-help = / збігається з текою вище, %skip% відкидає
...
tags-guess-placeholders = Підстановки
...
tags-rename-pattern-help = / робить теку від кореня бібліотеки, без / перейменовує на місці, розширення йде за файлом
...
convert-dialog-pattern-help = / робить теку, розширення задає формат
...
lyrics-bold = Жирний
lyrics-build-word-by-word = Стежити за словами
    .description = Вести позначку читання по активному рядку, за власними таймінгами слів, якщо вони є в аркуші
...
lyrics-head-build = Збирання
lyrics-head-fill = Заливка
lyrics-hide-upcoming = Приховувати наступні рядки
    .description = Тримати прихованим кожен рядок, до якого позначка ще не дійшла, щоб аркуш відкривався по ходу
...
lyrics-read-head-style = Позначка читання
    .description = Як активний рядок показує позначку: караоке-заливкою по всьому рядку чи словами, що збираються по черзі
...
lyrics-unsung-dim = Затемнення неспіваного
    .description = Наскільки заливка гасить ще не співану частину активного рядка
lyrics-wipe-lyrics = Стерти текст
lyrics-wrap-lines = Переносити довгі рядки
    .description = Хай заширокий для панелі рядок переходить на наступний, а не обрізається
...
player-stream-refused = Трек пропущено: { $reason }
