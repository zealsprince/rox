...
settings-appearance-chrome-side = Сторона кнопок вікна
    .description = З якого краю власного заголовка rox стоять кнопки; малюється лише там, де композитор не оформлює вікно
...
settings-appearance-chrome-style = Стиль кнопок вікна
    .description = Як малюються кнопки на власному заголовку rox; малюється лише там, де композитор не оформлює вікно
