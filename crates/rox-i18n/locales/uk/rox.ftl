...
menu-section-library = Медіатека
...
stats-bucket-listens = { $count ->
    [one] { $count } прослуховування, { $ago }
    [few] { $count } прослуховування, { $ago }
    [many] { $count } прослуховувань, { $ago }
   *[other] { $count } прослуховування, { $ago }
}
...
convert-dialog-pick-folder = Виберіть теку для запису
...
quick-play-narrow-by = Звузити за
...
particles-section-playback = Відтворення
...
genre-grid-show-names = Показувати назви
...
art-perspective = Перспектива
    .description = Повертати бічні обкладинки у справжньому 3D замість плаского стиснення
