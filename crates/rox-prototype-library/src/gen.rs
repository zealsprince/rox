...
const WORDS: &[&str] = &[
    ...
    "breath", "bright", "broken", "canyon", "cedar", "chalk", "chrome", "cinder", "circle", "city",
    "cloud", "coast", "cobalt", "cold", "copper", "coral", "crane", "crimson", "crystal", "dawn",
    "delta", "drift", "dusk", "dust", "echo", "ember", "empire", "evening", "fable", "fall",
    "feather", "fern", "field", "fire", "flood", "fog", "forest", "fox", "frost", "garden",
    "ghost", "glass", "gold", "granite", "grove", "harbor", "haze", "heart", "hollow", "honey",
    "horizon", "hour", "hunter", "ice", "iron", "island", "ivory", "jade", "june", "lantern",
    "lark", "light", "lily", "linen", "lion", "low", "lunar", "maple", "marble", "meadow",
    "midnight", "mirror", "mist", "moon", "moss", "mountain", "murmur", "neon", "night", "north",
    "oak", "ocean", "old", "opal", "orbit", "orchid", "owl", "paper", "pearl", "pine", "prairie",
    "quiet", "rain", "raven", "red", "reed", "river", "road", "rose", "ruby", "rust", "sable",
    "salt", "sand", "scarlet", "sea", "shadow", "signal", "silver", "sky", "slate", "slow",
    "smoke", "snow", "solar", "sparrow", "spring", "star", "static", "steel", "stone", "storm",
    "summer", "sun", "swan", "thistle", "thorn", "thunder", "tide", "timber", "topaz", "trace",
    "umber", "valley", "veil", "velvet", "violet", "wave", "west", "whale", "willow", "wind",
    "winter", "wire", "wolf", "wren",
];
